...
VALUES ('$courseID', '$lectureName', '$lectureID', '$goodBad', '$comment', '$user') ON DUPLICATE KEY UPDATE GoodBad='$goodBad', Comment='$comment'";
$result = $conn->query($sql);
...
if ($result === TRUE){
  ...
  echo 'Error! Could not update record:' . ' ' . $conn->error . '<br>';
}
