...
function submitForm(type) {
  ...
  if (type === 'new') {
    ...
    console.log('Update');
    var url = "http://script.studieradet.se/kurskurt/databaseFromAJAXUpdate.php";
  }
...
function lectureSelectFromDB(choice, fromResults) {
  ...
  $.ajax({
    url: 'http://script.studieradet.se/kurskurt/courseChoice.php',
...
function getPreviousAnswer(lectureName) {
  ...
  $.ajax({
    url: 'http://script.studieradet.se/kurskurt/previousAnswer.php',
...
function courseSelectFromDB() {
  ...
  $.ajax({
    url: 'http://script.studieradet.se/kurskurt/courseSelectFromDB.php',
    success: function(data){
        if (data.indexOf('Error') < 0){
...
function getCount() {
  ...
  $.ajax({
    url: 'http://script.studieradet.se/kurskurt/countEntries.php',
    data: {courseChoice: choice},
    success: function(data){
      if (data.indexOf('Error') < 0){
...
function haveAnswered() {
  ...
  $.ajax({
    url: 'http://script.studieradet.se/kurskurt/haveAnswered.php',
...
function scheduleNotifications() {
  ...
  $.ajax({
    url: 'http://script.studieradet.se/kurskurt/sendNotification.php',
